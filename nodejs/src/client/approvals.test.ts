...
describe('createApprovalsApi', () => {
  ...
  it('resolve calls POST .../approval-requests/:id/approve', async () => {
    let capturedPath: string | null = null;
  ...
  it('approve is a convenience wrapper around resolve', async () => {
    let capturedPath: string | null = null;
    ...
    const api = createApprovalsApi(http, { organization_id: 'org1' });
    const result = await api.approve('ar1');
  ...
  it('reject is a convenience wrapper around resolve', async () => {
    ...
    const api = createApprovalsApi(http, { organization_id: 'org1' });
    const result = await api.reject('ar1');

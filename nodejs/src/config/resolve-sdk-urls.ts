...
export const SDK_EXAMPLE_PATHS: ReadonlyArray<{ label: string; path: string }> = [
  ...
  { label: 'data_products: post query', path: '/dataproducts/warehouse/execute' },
  { label: 'data_products: list tables', path: '/dataproducts/warehouse/tables' },
  ...
  {
    label: 'targets/triggers: project entities connections',
    path: `/workflows/projects/${PH_ID}/entities`,
  },
